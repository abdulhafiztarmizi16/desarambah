                ...
                <div class="card-body pt-0 pt-md-4 pt-5">
                    <div class="text-center">
                        ...
                        <div class="h5 font-weight-300">
                            Kec. {{ $desa->nama_kecamatan }}, Kabupaten {{ $desa->nama_kabupaten }}
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <form action="{{ route('update-desa', $desa) }}" method="POST">
                        ...
                        <div class="form-group">
                            ...
                            <input name="nama_kecamatan" type="text" id="nama_kecamatan"
                                ...
                                value="{{ old('nama_kecamatan', $desa->nama_kecamatan) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input name="nama_kabupaten" type="text" id="nama_kabupaten"
                                ...
                                placeholder="Masukkan nama desa"
                                value="{{ old('nama_kabupaten', $desa->nama_kabupaten) }}">
                        ...
                        <div class="form-group">
                            <label class="form-control-label" for="tagline_desa">Tagline Desa</label>
                            <input name="tagline_desa" type="text" id="tagline_desa"
                                class="form-control form-control-alternative @error('tagline-desa') is-invalid @enderror"
                                placeholder="Masukkan tagline Desa" value="{{ old('tagline_desa', $desa->tagline_desa) }}">
                            @error('tagline_desa')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                        ...
                        {{-- <div class="form-group">
                            ...
                            <input name="kode_desa" type="text" id="kode_desa"
                                class="form-control form-control-alternative @error('kode_desa') is-invalid @enderror"
                                placeholder="Masukkan kode desa" value="{{ old('kode_desa', $desa->kode_desa) }}">
                            @error('kode_desa')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                        ...
                        <div class="form-group">
                            <label class="form-control-label" for="pengumuman">Pengumuman</label>
                            <textarea name="pengumuman" type="text" id="pengumuman" cols="30" rows="10"
                                class="form-control form-control-alternative @error('pengumuman') is-invalid @enderror">
                                {{ old('pengumuman', $desa->pengumuman) }}</textarea>
                            @error('pengumuman')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                        ...
                        <div class="form-group">
                            <label class="form-control-label" for="sejarah_desa">Sejarah Desa</label>
                            <textarea name="sejarah_desa" type="text" id="sejarah_desa" cols="30" rows="10"
                                class="form-control form-control-alternative @error('sejarah-desa') is-invalid @enderror">
                                {{ old('sejarah_desa', $desa->sejarah_desa) }}</textarea>
                            @error('sejarah_desa')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
