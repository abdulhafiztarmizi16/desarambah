                ...
                <form autocomplete="off" action="{{ route('penduduk.store') }}" method="post">
                    ...
                    <div class="row">
                        <div class="form-group col-lg-4 col-md-6">
                            ...
                            <input type="text" class="form-control @error('nik') is-invalid @enderror" name="nik" placeholder="Masukkan NIK ..." value="{{ old('nik') }}" maxlength="16" oninput="this.value = this.value.replace(/[^0-9]/g, '')">
                        ...
                        <div class="form-group col-lg-4 col-md-6">
                            ...
                            <input type="text" class="form-control @error('kk') is-invalid @enderror" name="kk" placeholder="Masukkan Nomor KK ..." value="{{ old('kk') }}" maxlength="16" oninput="this.value = this.value.replace(/[^0-9]/g, '')">
                        ...
                        <div class="form-group col-lg-4 col-md-6" id="div_nomor_paspor">
                            ...
                            <input type="text" class="form-control @error('nomor_paspor') is-invalid @enderror" name="nomor_paspor" id="nomor_paspor" placeholder="Masukkan Nomor Paspor ..." value="{{ old('nomor_paspor') }}" maxlength="16">
                        ...
                        <div class="form-group col-lg-4 col-md-6" id="div_nomor_kitas_atau_kitap">
                            ...
                            <input type="text" class="form-control @error('nomor_kitas_atau_kitap') is-invalid @enderror" name="nomor_kitas_atau_kitap" id="nomor_kitas_atau_kitap" placeholder="Masukkan Nomor KITAS / KITAP ..." value="{{ old('nomor_kitas_atau_kitap') }}" maxlength="16">
                        ...
                        {{-- <div class="form-group col-md-6">
                            ...
                            <input type="text" class="form-control @error('nik_ayah') is-invalid @enderror" name="nik_ayah" placeholder="Masukkan NIK Ayah ..." value="{{ old('nik_ayah') }}" maxlength="16" oninput="this.value = this.value.replace(/[^0-9]/g, '')">
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <input type="text" class="form-control @error('nik_ibu') is-invalid @enderror" name="nik_ibu" placeholder="Masukkan NIK Ibu ..." value="{{ old('nik_ibu') }}" maxlength="16" oninput="this.value = this.value.replace(/[^0-9]/g, '')">
