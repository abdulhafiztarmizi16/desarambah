                ...
                <form autocomplete="off" action="{{ route('penduduk.update', $penduduk) }}" method="post">
                    ...
                    <div class="row">
                        <div class="form-group col-lg-4 col-md-6">
                            ...
                            <input type="text" class="form-control @error('nik') is-invalid @enderror" name="nik" placeholder="Masukkan NIK ..." value="{{ old('nik', $penduduk->nik) }}" maxlength="16" oninput="this.value = this.value.replace(/[^0-9]/g, '')">
                        ...
                        <div class="form-group col-lg-4 col-md-6">
                            ...
                            <input type="text" class="form-control @error('kk') is-invalid @enderror" name="kk" placeholder="Masukkan No KK ..." value="{{ old('kk', $penduduk->kk) }}" maxlength="16" oninput="this.value = this.value.replace(/[^0-9]/g, '')">
                        ...
                        <div class="form-group col-lg-4 col-md-6" id="div_nomor_paspor">
                            <label class="form-control-label" for="nomor_paspor">Nomor Paspor</label>
                            <input type="text" class="form-control @error('nomor_paspor') is-invalid @enderror" name="nomor_paspor" id="nomor_paspor" placeholder="Masukkan Nomor Paspor ..." value="{{ old('nomor_paspor', $penduduk->nomor_paspor) }}">
                            @error('nomor_paspor')<span class="invalid-feedback font-weight-bold">{{ $message }}</span>@enderror
                        </div>
                        <div class="form-group col-lg-4 col-md-6" id="div_nomor_kitas_atau_kitap">
                            <label class="form-control-label" for="nomor_kitas_atau_kitap">Nomor KITAS / KITAP</label>
                            <input type="text" class="form-control @error('nomor_kitas_atau_kitap') is-invalid @enderror" id="nomor_kitas_atau_kitap" name="nomor_kitas_atau_kitap" placeholder="Masukkan Nomor KITAS / KITAP ..." value="{{ old('nomor_kitas_atau_kitap', $penduduk->nomor_kitas_atau_kitap) }}">
                        ...
                        {{-- <div class="form-group col-md-6">
                            ...
                            <input type="text" class="form-control @error('nik_ayah') is-invalid @enderror" name="nik_ayah" placeholder="Masukkan NIK Ayah ..." value="{{ old('nik_ayah', $penduduk->nik_ayah) }}" maxlength="16" oninput="this.value = this.value.replace(/[^0-9]/g, '')">
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <input type="text" class="form-control @error('nik_ibu') is-invalid @enderror" name="nik_ibu" placeholder="Masukkan NIK Ibu ..." value="{{ old('nik_ibu', $penduduk->nik_ibu) }}" maxlength="16" oninput="this.value = this.value.replace(/[^0-9]/g, '')">
...
<script>
    ...
    // script paspor dan kitas
    $(document).ready(function() {
        const $kewarganegaraanSelect = $("#kewarganegaraan");
        const $divNomorPaspor = $("#div_nomor_paspor");
        const $divNomorKitasKitap = $("#div_nomor_kitas_atau_kitap");

        // Fungsi untuk menyembunyikan elemen dengan CSS
        ...
        // Inisialisasi tampilan awal berdasarkan pilihan kewarganegaraan yang ada
        function initializeDisplay() {
            if ($kewarganegaraanSelect.val() === "1") { // WNI
                hideElement($divNomorPaspor);
                hideElement($divNomorKitasKitap);
            } else if ($kewarganegaraanSelect.val() === "2" || $kewarganegaraanSelect.val() === "3") { // WNA atau Dua Kewarganegaraan
                showElement($divNomorPaspor);
                showElement($divNomorKitasKitap);
            }
        }
        ...
        // Tambahkan event listener pada perubahan pilihan kewarganegaraan
        $kewarganegaraanSelect.on("change", function() {
            initializeDisplay();
        });
    });
</script>
