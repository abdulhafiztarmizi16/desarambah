...
class PendudukRequest extends FormRequest
{
    ...
    {
        $rules = [
            'nik'                               => ['required','digits:16','different:kk'],
            ...
            'status_hubungan_dalam_keluarga_id' => ['nullable','numeric'],
    ...
    public function messages()
    {
        return [
            ...
            'nik.different' => 'NIK dan KK tidak boleh memiliki isian yang sama.',
            'nik.unique' => 'NIK yang ditambahkan sudah ada',
